...
class FistacheParserDefinition : HTMLParserDefinition() {
    override fun createLexer(project: Project): Lexer {
        return FistacheLexer()
    }
            ...
            override fun createHtmlParsing(builder: PsiBuilder): HtmlParsing {
                return object: HtmlParsing(builder) {
                    override fun isSingleTag(tagName: String, originalTagName: String): Boolean {
                        // There are heavily-used Fistache components called like 'Col' or 'Input'. Unlike HTML tags <col> and <input> Fistache components do have closing tags.
    ...
    companion object {
        internal var HTML_FILE: IFileElementType = IStubFileElementType<PsiFileStub<HtmlFileImpl>>(FistacheLanguage.INSTANCE)
    }
}