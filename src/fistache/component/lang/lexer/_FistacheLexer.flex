...
package fistache.component.lang.lexer;
...
%{
  public _FistacheLexer() {
    this((java.io.Reader)null);
  }
%}

%class _FistacheLexer
%public
...
<ATTRIBUTE_VALUE_START> "{" { yybegin(ATTRIBUTE_VALUE_BQ); return XmlTokenType.XML_ATTRIBUTE_VALUE_START_DELIMITER; }
