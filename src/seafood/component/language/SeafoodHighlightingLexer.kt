...
class SeafoodHighlightingLexer(private val languageLevel: JSLanguageLevel) : HtmlHighlightingLexer(), SeafoodHandledLexer {
    ...
    override fun getStyleLanguage(): Language? {
        return styleViaLang() ?: super.getStyleLanguage()
    }
