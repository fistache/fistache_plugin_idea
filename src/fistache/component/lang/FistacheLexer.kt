...
class FistacheLexer : HtmlLexer(MergingLexerAdapter(FlexAdapter(fistache.component.lang.lexer._FistacheLexer()), TokenSet.create(XmlTokenType.XML_COMMENT_CHARACTERS, XmlTokenType.XML_WHITE_SPACE, XmlTokenType.XML_REAL_WHITE_SPACE,
        XmlTokenType.XML_ATTRIBUTE_VALUE_TOKEN, XmlTokenType.XML_DATA_CHARACTERS,
        XmlTokenType.XML_TAG_CHARACTERS)), true), FistacheHandledLexer {
    ...
    override fun getTokenType(): IElementType? {
        ...
        if (seenAttributeExpression && type == XmlTokenType.XML_ATTRIBUTE_VALUE_TOKEN) {
            return FistacheElementTypes.EMBEDDED_TS
        }
